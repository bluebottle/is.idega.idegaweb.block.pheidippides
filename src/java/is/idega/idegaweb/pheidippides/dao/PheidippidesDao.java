...
public interface PheidippidesDao extends GenericDao {
    ...
    public void updateDiscountCode(Long discountCodePK, Company company,
            int discountPercentage, int discountAmount, Date validUntil,
            boolean enabled);
    ...
    public Race storeRace(Long raceID, int year, Event event, Distance distance,
            int minimumAge, int maximumAge, Date openRegistration,
            Date closeRegistration, boolean familyDiscount, int relayLegs,
