...
public class CharityServiceServiceLocator extends org.apache.axis.client.Service implements is.idega.idegaweb.pheidippides.webservice.server.CharityServiceService {
    ...
    public is.idega.idegaweb.pheidippides.webservice.server.CharityService_PortType getCharityService() throws javax.xml.rpc.ServiceException {
    ...
    public is.idega.idegaweb.pheidippides.webservice.server.CharityService_PortType getCharityService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            is.idega.idegaweb.pheidippides.webservice.server.CharityServiceSoapBindingStub _stub = new is.idega.idegaweb.pheidippides.webservice.server.CharityServiceSoapBindingStub(portAddress, this);
