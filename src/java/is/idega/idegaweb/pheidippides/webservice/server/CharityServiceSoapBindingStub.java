...
public class CharityServiceSoapBindingStub extends org.apache.axis.client.Stub implements is.idega.idegaweb.pheidippides.webservice.server.CharityService_PortType {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.setReturnClass(is.idega.idegaweb.pheidippides.webservice.server.Session.class);
    ...
    public CharityServiceSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            cls = is.idega.idegaweb.pheidippides.webservice.server.Charity[].class;
            ...
            cachedSerQNames.add(qName);
            cls = is.idega.idegaweb.pheidippides.webservice.server.CharityInformation.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = is.idega.idegaweb.pheidippides.webservice.server.Session.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = is.idega.idegaweb.pheidippides.webservice.server.SessionTimedOutException.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {charityPersonalID});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                return (is.idega.idegaweb.pheidippides.webservice.server.CharityInformation) _resp;
            } catch (java.lang.Exception _exception) {
                return (is.idega.idegaweb.pheidippides.webservice.server.CharityInformation) org.apache.axis.utils.JavaUtils.convert(_resp, is.idega.idegaweb.pheidippides.webservice.server.CharityInformation.class);
            }
        }
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {loginName, password});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            extractAttachments(_call);
            try {
                return (is.idega.idegaweb.pheidippides.webservice.server.Session) _resp;
            } catch (java.lang.Exception _exception) {
                return (is.idega.idegaweb.pheidippides.webservice.server.Session) org.apache.axis.utils.JavaUtils.convert(_resp, is.idega.idegaweb.pheidippides.webservice.server.Session.class);
            }
        }
  } catch (org.apache.axis.AxisFault axisFaultException) {
  throw axisFaultException;
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {session, identifier, password});
    ...
    if (axisFaultException.detail != null) {
        ...
        if (axisFaultException.detail instanceof is.idega.idegaweb.pheidippides.webservice.server.SessionTimedOutException) {
              throw (is.idega.idegaweb.pheidippides.webservice.server.SessionTimedOutException) axisFaultException.detail;
         }
   }
  throw axisFaultException;
}
