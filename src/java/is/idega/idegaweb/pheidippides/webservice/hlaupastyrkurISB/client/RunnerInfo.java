...
public class RunnerInfo  implements java.io.Serializable {
    ...
    private is.idega.idegaweb.pheidippides.webservice.hlaupastyrkurISB.client.RelayPartnerInfo[] partners;
    ...
    private is.idega.idegaweb.pheidippides.webservice.hlaupastyrkurISB.client.Session session;
    ...
    public RunnerInfo(
           ...
           is.idega.idegaweb.pheidippides.webservice.hlaupastyrkurISB.client.RelayPartnerInfo[] partners,
     ...
     * @return partners
     */
    public is.idega.idegaweb.pheidippides.webservice.hlaupastyrkurISB.client.RelayPartnerInfo[] getPartners() {
        return partners;
    }
     ...
     * @param partners
     */
    public void setPartners(is.idega.idegaweb.pheidippides.webservice.hlaupastyrkurISB.client.RelayPartnerInfo[] partners) {
        this.partners = partners;
    }
     ...
     * @return session
     */
    public is.idega.idegaweb.pheidippides.webservice.hlaupastyrkurISB.client.Session getSession() {
        return session;
    }
     ...
     * @param session
     */
    public void setSession(is.idega.idegaweb.pheidippides.webservice.hlaupastyrkurISB.client.Session session) {
        this.session = session;
    }
