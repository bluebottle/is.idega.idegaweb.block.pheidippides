...
public class ISBServiceServiceLocator extends org.apache.axis.client.Service implements is.idega.idegaweb.pheidippides.webservice.isb.server.ISBServiceService {

	private static final long serialVersionUID = -6381664268467458979L;
    ...
    public is.idega.idegaweb.pheidippides.webservice.isb.server.ISBService_PortType getISBService() throws javax.xml.rpc.ServiceException {
    ...
    public is.idega.idegaweb.pheidippides.webservice.isb.server.ISBService_PortType getISBService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            is.idega.idegaweb.pheidippides.webservice.isb.server.ISBServiceSoapBindingStub _stub = new is.idega.idegaweb.pheidippides.webservice.isb.server.ISBServiceSoapBindingStub(portAddress, this);
	...
	public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (is.idega.idegaweb.pheidippides.webservice.isb.server.ISBService_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                is.idega.idegaweb.pheidippides.webservice.isb.server.ISBServiceSoapBindingStub _stub = new is.idega.idegaweb.pheidippides.webservice.isb.server.ISBServiceSoapBindingStub(new java.net.URL(ISBService_address), this);
                _stub.setPortName(getISBServiceWSDDServiceName());
                return _stub;
            }
        }
