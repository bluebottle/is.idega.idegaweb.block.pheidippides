...
public class ISBServiceSoapBindingStub extends org.apache.axis.client.Stub implements is.idega.idegaweb.pheidippides.webservice.isb.server.ISBService_PortType {
    ...
    private static void _initOperationDesc1(){
        ...
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://illuminati.is", "in0"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://illuminati.is", "Login"), is.idega.idegaweb.pheidippides.webservice.isb.server.Login.class, false, false);
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://illuminati.is", "Session"));
        oper.setReturnClass(is.idega.idegaweb.pheidippides.webservice.isb.server.Session.class);
        ...
        oper.addFault(new org.apache.axis.description.FaultDesc(
                      ...
                      "is.idega.idegaweb.pheidippides.webservice.isb.server.SessionTimedOutException",
    ...
    public ISBServiceSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            cls = is.idega.idegaweb.pheidippides.webservice.isb.server.RelayPartnerInfo[].class;
            ...
            cachedSerQNames.add(qName);
            cls = is.idega.idegaweb.pheidippides.webservice.isb.server.Login.class;
            cachedSerClasses.add(cls);
            ...
            cachedSerQNames.add(qName);
            cls = is.idega.idegaweb.pheidippides.webservice.isb.server.RunnerInfo.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = is.idega.idegaweb.pheidippides.webservice.isb.server.Session.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = is.idega.idegaweb.pheidippides.webservice.isb.server.SessionTimedOutException.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {in0});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                return (is.idega.idegaweb.pheidippides.webservice.isb.server.Session) _resp;
            } catch (java.lang.Exception _exception) {
                return (is.idega.idegaweb.pheidippides.webservice.isb.server.Session) org.apache.axis.utils.JavaUtils.convert(_resp, is.idega.idegaweb.pheidippides.webservice.isb.server.Session.class);
            }
        }
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {in0});
    ...
    if (axisFaultException.detail != null) {
        ...
        if (axisFaultException.detail instanceof is.idega.idegaweb.pheidippides.webservice.isb.server.SessionTimedOutException) {
              throw (is.idega.idegaweb.pheidippides.webservice.isb.server.SessionTimedOutException) axisFaultException.detail;
         }
   }
  throw axisFaultException;
}
