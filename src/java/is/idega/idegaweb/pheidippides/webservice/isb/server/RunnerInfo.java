...
public class RunnerInfo  implements java.io.Serializable {
	...
	private static final long serialVersionUID = -7854167287503462089L;
    ...
    private is.idega.idegaweb.pheidippides.webservice.isb.server.RelayPartnerInfo[] partners;
    ...
    private is.idega.idegaweb.pheidippides.webservice.isb.server.Session session;
    ...
    public RunnerInfo(
           ...
           is.idega.idegaweb.pheidippides.webservice.isb.server.RelayPartnerInfo[] partners,
     ...
     * @return partners
     */
    public is.idega.idegaweb.pheidippides.webservice.isb.server.RelayPartnerInfo[] getPartners() {
        return partners;
    }
     ...
     * @param partners
     */
    public void setPartners(is.idega.idegaweb.pheidippides.webservice.isb.server.RelayPartnerInfo[] partners) {
        this.partners = partners;
    }
     ...
     * @return session
     */
    public is.idega.idegaweb.pheidippides.webservice.isb.server.Session getSession() {
        return session;
    }
     ...
     * @param session
     */
    public void setSession(is.idega.idegaweb.pheidippides.webservice.isb.server.Session session) {
        this.session = session;
    }
