...
public class BasicHttpBinding_IContestantServiceStub extends org.apache.axis.client.Stub implements is.idega.idegaweb.pheidippides.webservice.hlaupastyrkur.client.IContestantService {
    ...
    private static void _initOperationDesc1(){
        ...
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://tmsoftware.is/charities/services/", "request"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://tmsoftware.is/charities/services/", "UpdateContestantRequest"), is.idega.idegaweb.pheidippides.webservice.hlaupastyrkur.client.UpdateContestantRequest.class, false, false);
        param.setOmittable(true);
        param.setNillable(true);
        oper.addParameter(param);
        oper.setReturnType(org.apache.axis.encoding.XMLType.AXIS_VOID);
        ...
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://tmsoftware.is/charities/services/", "request"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://tmsoftware.is/charities/services/", "TeamRequest"), is.idega.idegaweb.pheidippides.webservice.hlaupastyrkur.client.TeamRequest.class, false, false);
        param.setOmittable(true);
        param.setNillable(true);
        oper.addParameter(param);
        oper.setReturnType(org.apache.axis.encoding.XMLType.AXIS_VOID);
        ...
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://tmsoftware.is/charities/services/", "request"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://tmsoftware.is/charities/services/", "UpdateTeamRequest"), is.idega.idegaweb.pheidippides.webservice.hlaupastyrkur.client.UpdateTeamRequest.class, false, false);
        param.setOmittable(true);
        param.setNillable(true);
        oper.addParameter(param);
        oper.setReturnType(org.apache.axis.encoding.XMLType.AXIS_VOID);
	...
	public BasicHttpBinding_IContestantServiceStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            cachedSerQNames.add(qName);
            cls = is.idega.idegaweb.pheidippides.webservice.hlaupastyrkur.client.BaseRequest.class;
            cachedSerClasses.add(cls);
            ...
            cachedSerQNames.add(qName);
            cls = is.idega.idegaweb.pheidippides.webservice.hlaupastyrkur.client.ContestantRequest.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = is.idega.idegaweb.pheidippides.webservice.hlaupastyrkur.client.Login.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = is.idega.idegaweb.pheidippides.webservice.hlaupastyrkur.client.RegisterRequest.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = is.idega.idegaweb.pheidippides.webservice.hlaupastyrkur.client.TeamRequest.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = is.idega.idegaweb.pheidippides.webservice.hlaupastyrkur.client.UpdateContestantRequest.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = is.idega.idegaweb.pheidippides.webservice.hlaupastyrkur.client.UpdateRequest.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = is.idega.idegaweb.pheidippides.webservice.hlaupastyrkur.client.UpdateTeamRequest.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = is.idega.idegaweb.pheidippides.webservice.hlaupastyrkur.client.ServiceException.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = is.idega.idegaweb.pheidippides.webservice.hlaupastyrkur.client.ServiceFault.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {request});
    ...
    if (axisFaultException.detail != null) {
        ...
        if (axisFaultException.detail instanceof is.idega.idegaweb.pheidippides.webservice.hlaupastyrkur.client.ServiceFault) {
              throw (is.idega.idegaweb.pheidippides.webservice.hlaupastyrkur.client.ServiceFault) axisFaultException.detail;
         }
   }
