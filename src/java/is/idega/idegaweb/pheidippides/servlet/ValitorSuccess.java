		...
		if (header.getStatus().equals(RegistrationHeaderStatus.WaitingForPayment)) {
			...
			for (Registration registration : registrations) {
				if (registration.getRace().getEvent().getPaymentSecurityNumber() != null) {
					securityNumber = registration.getRace().getEvent().getPaymentSecurityNumber();
				}
				else if (registration.getRace().getEvent().getReportSign().equals("TOR") || registration.getRace().getEvent().getReportSign().equals("NLH") || registration.getRace().getEvent().getReportSign().equals("RIG")) {
