...
public class TourRegistrationForm extends IWBaseComponent {
		...
		if (event != null) {
			...
			case ACTION_SHIRT_SELECT:
				if (getSession().getCurrentParticipant() != null) {
					...
					List<RaceShirtSize> shirts = getDao().getRaceShirtSizes(
							getDao().getRace(getSession().getCurrentParticipant().getRace().getId()));
	...
	private void showPersonSelect(IWContext iwc, PheidippidesBean bean) {
		...
		facelet.setFaceletURI(iwb.getFaceletURI("registration/TOR/personSelect.xhtml"));
		add(facelet);
	}
	...
	private void showParticipant(IWContext iwc, PheidippidesBean bean) {
		...
		FaceletComponent facelet = (FaceletComponent) iwc.getApplication()
				.createComponent(FaceletComponent.COMPONENT_TYPE);
		facelet.setFaceletURI(iwb.getFaceletURI("registration/TOR/participant.xhtml"));
		add(facelet);
	}
	...
	private void showRaceSelect(IWContext iwc, PheidippidesBean bean) {
		...
		FaceletComponent facelet = (FaceletComponent) iwc.getApplication()
				.createComponent(FaceletComponent.COMPONENT_TYPE);
		facelet.setFaceletURI(iwb.getFaceletURI("registration/TOR/raceSelect.xhtml"));
		add(facelet);
	}
	...
	private void showShirtSelect(IWContext iwc, PheidippidesBean bean) {
		...
		FaceletComponent facelet = (FaceletComponent) iwc.getApplication()
				.createComponent(FaceletComponent.COMPONENT_TYPE);
		facelet.setFaceletURI(iwb.getFaceletURI("registration/TOR/shirtSelect.xhtml"));
		add(facelet);
	}
	...
	private void showWaiver(IWContext iwc, PheidippidesBean bean) {
		FaceletComponent facelet = (FaceletComponent) iwc.getApplication()
				.createComponent(FaceletComponent.COMPONENT_TYPE);
		facelet.setFaceletURI(iwb.getFaceletURI("registration/TOR/waiver.xhtml"));
		add(facelet);
	}
	...
	private void showOverview(IWContext iwc, PheidippidesBean bean) {
		FaceletComponent facelet = (FaceletComponent) iwc.getApplication()
				.createComponent(FaceletComponent.COMPONENT_TYPE);
		facelet.setFaceletURI(iwb.getFaceletURI("registration/TOR/overview.xhtml"));
		add(facelet);
	}
	...
	private void showReceipt(IWContext iwc, PheidippidesBean bean) {
		FaceletComponent facelet = (FaceletComponent) iwc.getApplication()
				.createComponent(FaceletComponent.COMPONENT_TYPE);
		facelet.setFaceletURI(iwb.getFaceletURI("registration/TOR/receipt.xhtml"));
		add(facelet);
	}
	...
	private void showGiftCard(IWContext iwc, PheidippidesBean bean) {
		FaceletComponent facelet = (FaceletComponent) iwc.getApplication()
				.createComponent(FaceletComponent.COMPONENT_TYPE);
		facelet.setFaceletURI(iwb.getFaceletURI("registration/TOR/giftCard.xhtml"));
		add(facelet);
	}
