...
public class Watchlist extends IWBaseComponent {
	...
	protected void initializeComponent(FacesContext context) {
		...
		PresentationUtil.addJavaScriptSourceLineToHeader(iwc, iwb.getVirtualPathWithFileNameString("javascript/watchlist.js"));
		...
		if (school != null && year != null) {
			students = getService().getStudents(school, year, schoolClass);
		...
		facelet.setFaceletURI(iwb.getFaceletURI("watchlist/view.xhtml"));
		add(facelet);
	}
